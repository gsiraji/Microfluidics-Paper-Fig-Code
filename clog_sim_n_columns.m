...
if c_mode == 0
    ...
    markersz = [5,7]; %set the marker sizes for the plot
    ...
    plot(Tqq_1(:,8),Tqq_1(:,1), 'o','MarkerSize', markersz(2),'LineWidth',2, 'MarkerEdgeColor','r','MarkerFaceColor','none', 'DisplayName', label1)
    hold on;
    % %%%%lambda = q plot
    % exact solution
    plot(Tqexact(:,1), Tqexact(:,2), '--', 'lineWidth', 3,'Color','#A2142F', 'DisplayName', label33)
    hold on;
    % stochastic error bars 
    errorbar(Tq(:,8),Tq(:,1), Tq(:,3), '.','HandleVisibility','off', 'MarkerEdgeColor', 'none', 'color', 'b');
    hold on;
    % stochastic data points
    plot(Tq(:,8),Tq(:,1), 'd','MarkerSize', markersz(1),'MarkerEdgeColor','b','MarkerFaceColor','b', 'DisplayName', label3)
    hold on;
    % %%%%lambda = q^2 plot
    % stochastic data points
    plot(Tq2exact(:,1), Tq2exact(:,2),'-.', 'lineWidth', 3, 'Color', [0.4940 0.1840 0.5560],'DisplayName', label22) ;
    hold on;
    % stochastic data error bars
    errorbar(Tq2(:,8),Tq2(:,1), Tq2(:,3), '.','HandleVisibility','off', 'MarkerEdgeColor', 'none', 'color', 'm');
    hold on;
    plot(Tq2(:,8),Tq2(:,1), '^','MarkerSize', markersz(1), 'MarkerEdgeColor','m','MarkerFaceColor','m', 'DisplayName', label2)
    ...
    hold on;
    plot(Tqq_1(:,8),Tqq_1(:,2), 'o','MarkerSize', markersz(2),'LineWidth',2, 'MarkerEdgeColor','r','MarkerFaceColor','none', 'DisplayName', label1)
    hold on;
    ...
    hold on;
    plot(Tq(:,8),Tq(:,2), 'd','MarkerSize', markersz(1),'MarkerEdgeColor','b','MarkerFaceColor','b', 'DisplayName', label3)
    hold on;
    ...
    hold on
    plot(Tq2(:,8),Tq2(:,2), '^','MarkerSize', markersz(1), 'MarkerEdgeColor','m','MarkerFaceColor','m', 'DisplayName', label2)
